...
echo
	...
	buildFolder=$(pwd)"/arcobobo-build"
	outFolder=$(pwd)"/ArcoBobo-Out"
...
############################################################################
	...
	echo
	cp -rf ../personal/. $buildFolder/archiso/airootfs/etc/skel/
  cp -rf ../personal-home/. $buildFolder/archiso/airootfs/etc/skel/
  cp -rf ../personal-root/. $buildFolder/archiso/airootfs/
